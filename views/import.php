...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="tw-mb-3 tw-flex tw-flex-wrap tw-items-center tw-justify-between tw-gap-2">
                    <div>
                        <h4 class="tw-my-0 tw-font-bold tw-text-lg tw-text-neutral-700">
                            <?= _l('import_leads'); ?>
                        </h4>
                        <p class="text-muted tw-mb-0 tw-mt-1"><?= _l('siba_leads_import_desc'); ?></p>
                    </div>
                        ...
                        <div class="tw-mt-4">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    echo render_leads_source_select(
                                        $sources,
                                    ...
                                    <?= render_select(
                                        ...
                                        'leads_import_assignee',
                                        $this->input->post('responsible')
                                    ); ?>
